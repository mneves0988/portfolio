  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[960px] mx-auto px-4 text-center">
        ...
        {/* Main Title */}
        <h2 className="text-hero-title md:text-6xl font-semibold text-foreground mb-8 leading-tight opacity-0 animate-fade-in-up" style={{ animationDelay: "100ms", animationFillMode: "forwards" }}>
        ...
        {/* Subtitle */}
        <p className="text-hero-subtitle text-muted-foreground max-w-[603px] mx-auto leading-relaxed opacity-0 animate-fade-in-up" style={{ animationDelay: "200ms", animationFillMode: "forwards" }}>
